...
const PropertiesTable = dynamic(() => import("@/components/dashboard/PropertiesTable"), { ssr: false, loading: () => <div>Cargando tabla...</div> });
const DashboardStats = dynamic(() => import("@/components/dashboard/DashboardStats"), { ssr: false, loading: () => <div>Cargando estadísticas...</div> });
                    ...
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                      {item.agency?.logo ? (
                        <Image
                          ...
                          unoptimized={item.agency.logo.startsWith("data:")}
                        />
                      ) : (
